      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8 animate-fade-in">
            ...
            <h1 className="font-pacifico text-4xl text-romantic mb-2">LoveLink</h1>
            <p className="text-lg text-muted-foreground font-medium">You + Me = Forever ✨</p>
          </div>
              ...
              <div className="flex bg-muted rounded-full p-1 mb-6">
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-full text-sm font-medium transition-all duration-300 ${
                    isLogin ? 'btn-romantic' : 'text-muted-foreground hover:text-foreground'
                  }`}
                >
                  Sign In
                </button>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 rounded-full border-border focus:ring-primary"
                  />
                  <button
                    type="button"
